...
class TestSSpeedColor(unittest.TestCase):
    ...
    def test_green(self):
        ...
        self.assertEqual("green", rf.get_color(params, rf.SPEED_TRACK), 'expect green color')
    ...
    def test_orange(self):
        ...
        self.assertEqual("orange", rf.get_color(params, rf.SPEED_TRACK), 'expect orange color')

    def test_red(self):
        self.set_speed_track()
        params = {
            "closest_waypoints": [222, 223],
        }
        self.assertEqual("red", rf.get_color(params, rf.SPEED_TRACK), 'if index is our of SPEED_TRACK - return red color')
